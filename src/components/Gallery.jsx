          ...
          <div className="container mx-auto px-4 text-center flex flex-col items-center max-w-7xl">
            ...
            <div className="mt-8 grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 md:gap-6 gap-4">
              {imageUrls.map((img, idx) => (
                <div
                  key={idx}
                  className="bg-white rounded-2xl shadow-lg shadow-gray-400 hover:shadow-lg hover:shadow-gray-600 transition-shadow duration-500 cursor-pointer transform hover:scale-102"
